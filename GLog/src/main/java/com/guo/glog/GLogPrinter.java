...
import static com.guo.glog.GLog.ASSERT;
import static com.guo.glog.GLog.DEBUG;
import static com.guo.glog.GLog.ERROR;
import static com.guo.glog.GLog.INFO;
import static com.guo.glog.GLog.VERBOSE;
import static com.guo.glog.GLog.WARN;
...
public class GLogPrinter implements Printer {
    ...
    private final List<GLogAdapter> logAdapters = new ArrayList<>();
    ...
    public synchronized void log(int priority,
        ...
        for (GLogAdapter adapter : logAdapters) {
    ...
    @Override
    public void addAdapter(@NonNull GLogAdapter adapter) {
