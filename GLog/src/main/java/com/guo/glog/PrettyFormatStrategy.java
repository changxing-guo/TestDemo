...
public class PrettyFormatStrategy implements GLogStrategy{
    ...
    @NonNull
    private final GLogStrategy logStrategy;
    @Nullable
    ...
    private int getStackOffset(@NonNull StackTraceElement[] trace) {
        ...
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals(GLogPrinter.class.getName()) && !name.equals(GLog.class.getName())) {
                return --i;
            }
        }
        return -1;
    ...
    public static class Builder {
        ...
        @NonNull
        public Builder logStrategy(@Nullable GLogStrategy val) {
            logStrategy = val;
            return this;
        }
        ...
        public PrettyFormatStrategy build() {
            if (logStrategy == null) {
                logStrategy = new LogcatGLogStrategy();
            }
